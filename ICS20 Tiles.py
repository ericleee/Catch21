...
icon = pygame.image.load('Catch21-main\Catch21-main\clay.png')
pygame.display.set_icon(icon)
clock = pygame.time.Clock()
start = 75350
#player image
playerImg = pygame.image.load('Catch21-main\Catch21-main\minus-big-symbol.png')
playerX = 270
playerY = 480
player_Xchange = 0
#box image
boxImg1 = pygame.image.load('Catch21-main\Catch21-main\clay.png')
boxX1 = 270
boxY1 = 0
box_Ychange1 = 0
box_Xchange1 = 0

boxImg2 = pygame.image.load('Catch21-main\Catch21-main\clay.png')
boxX2 = 500
boxY2 = -400
box_Ychange2 = 0
box_Xchange2 = 0

boxImg3 = pygame.image.load('Catch21-main\Catch21-main\clay.png')
boxX3 = 20
boxY3 = -600
box_Ychange3 = 0
box_Xchange3 = 0

boxImg4 = pygame.image.load('Catch21-main\Catch21-main\clay.png')
boxX4 = 700
boxY4 = -800
box_Ychange4 = 0
box_Xchange4 = 0
...
while Menu == True:
    ...
    pygame.display.flip()
#music
mixer.music.load('Catch21-main\Catch21-main\circles.wav.mp3')
